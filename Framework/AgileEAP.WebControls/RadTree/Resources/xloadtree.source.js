...
function WebFXLoadTreeItem(sText, sXmlSrc, sAction, eParent, sIcon, sOpenIcon,nodeId,arrModelId,arrModelName,expand,anchorType,nodeType,arrPurview,title,linkUrl) {
	// call super
    this.WebFXTreeItem = WebFXTreeItem;
	this.WebFXTreeItem(sText, sAction, eParent, sIcon, sOpenIcon ,nodeId ,arrModelId,arrModelName,expand,anchorType,nodeType,arrPurview,title,linkUrl);
	// setup default property values
	this.src = sXmlSrc;
	this.loading = false;
	this.loaded = false;
...
function _xmlTreeToJsTree(oNode) {
	...
	var linkUrl = oNode.getAttribute("linkUrl");
	// create jsNode
	var jsNode;
	if (src != null && src != "")
		jsNode = new WebFXLoadTreeItem(text, src, action, parent, icon, openIcon,nodeId,arrModelId,arrModelName,expand,anchorType,nodeType,arrPurview,title,linkUrl);
else
		jsNode = new WebFXTreeItem(text, action, parent, icon, openIcon,nodeId,arrModelId,arrModelName,expand,anchorType,nodeType,arrPurview,title,linkUrl);
