    ...
    public partial class WebHelper : IWebHelper
    {
            ...
            else
            {
                if (SslEnabled())
                {
                    ...
                    if (!String.IsNullOrEmpty(sharedSslUrl))
                    {
                         ...
                         * but we cannot reference AgileEAP.BusinessLogic.dll assembly.
        ...
        public virtual void RestartAppDomain(string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new EAPException("AgileEAPCommerce needs to be restarted due to a configuration change, but was unable to do so.\r\n" +
        ...
        private bool TryWriteGlobalAsax()
        {
            try
            {
                //When a new plugin is dropped in the Plugins folder and is installed into AgileEAPCommerce, 
                ...
                //The issue is described here: http://www.AgileEAPcommerce.com/boards/t/10969/AgileEAP-20-plugin.aspx?p=4#51318
        ...
        public virtual bool IsSearchEngine(HttpRequestBase request)
        {
            ...
            {
                GlobalLogger.Error<WebHelper>(exc);
            }
            return result;
        }
    }
