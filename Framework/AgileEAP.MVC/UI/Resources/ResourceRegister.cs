...
namespace AgileEAP.UI.Resources
{
    public class ResourceRegister
    {
        ...
        public ResourceRegister(IViewDataContainer container, IResourceManager resourceManager, string resourceType)
        {
            ...
            {
                var webPage = container as WebViewPage;// WebPageBase;//WebViewPage;// 
                if (webPage != null)
                {
        ...
        public virtual RequireSettings Require(string resourceName)
        {
            ...
            var settings = ResourceManager.Require(ResourceType, resourceName, _viewVirtualPath.GetHashCode());
