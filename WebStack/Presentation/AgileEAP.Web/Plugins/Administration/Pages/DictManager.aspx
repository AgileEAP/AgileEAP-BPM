<%@ Page Title="" Language="C#" MasterPageFile="../Master/Page.Master" AutoEventWireup="true"
    CodeBehind="DictManager.aspx.cs" Inherits="AgileEAP.Administration.DictManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlace" runat="server">
    ...
    <div id="divContent">
        <div id="treeContainer" style="float: left; border-collapse: collapse;
            border-top: 1px #bfbfbf solid; border-right: 1px #bfbfbf solid;">
            <iframe id="ifrTree" name="ifrTree" src="DictTree.aspx" width="100%"
