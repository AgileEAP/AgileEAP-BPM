...
namespace AgileEAP.MVC.EmbeddedViews
{
    public class EmbeddedViewVirtualPathProvider : VirtualPathProvider
    {
        ...
        private bool IsEmbeddedView(string virtualPath)
        {
            ...
            for example: both AgileEAP.Plugin.Plugin1 and AgileEAP.Plugin.Plugin2 can have Views\Config\Configure.cshtml files
        ...
        {
            return (Previous.FileExists(virtualPath) || IsEmbeddedView(virtualPath));
        }
