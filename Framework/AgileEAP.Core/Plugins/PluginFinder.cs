...
namespace AgileEAP.Core.Plugins
{
    ...
    public class PluginFinder : IPluginFinder
    {
        ...
        public virtual IEnumerable<T> GetPlugins<T>(bool installedOnly = true) where T : class, IPluginInstaller
        {
        ...
        public virtual IEnumerable<PluginDescriptor> GetPluginDescriptors<T>(bool installedOnly = true) where T : class, IPluginInstaller
        {
            EnsurePluginsAreLoaded();
        ...
        public virtual PluginDescriptor GetPluginDescriptorBySystemName<T>(string systemName, bool installedOnly = true) where T : class, IPluginInstaller
        {
