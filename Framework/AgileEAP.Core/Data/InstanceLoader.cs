...
namespace AgileEAP.Core.Data
{
    ...
    public class InstanceLoader
    {
        ...
        public static object LoadByConstrutor(System.Type t)
        {
            ...
            if (ci == null)
            {
                throw new EAPException(t.Name + " must have a public constructor without parameter");
            }
        ...
        public static object Load(System.Type t)
        {
            ...
            if (retVal == null)
            {
                throw new EAPException("The type " + t.Name
                                                               +
        ...
        public static T Load<T>(string name)
        {
            ...
            if (type == null)
            {
                throw new EAPException("Type " + name + " not found.");
            }
            return (T)Load(type);
        }
