...
namespace AgileEAP.Core.Localization
{
    public static class LocalizationExtentions
    {
        ...
        public static string GetLocalized<T>(this T entity,
            ...
            where T : Domain.DomainObject<string>, ILocalizedEntity
        {
            var workContext = EngineContext.Current.Resolve<IWorkContext>();
            return GetLocalized(entity, keySelector, workContext.Language.ID);
        }
        /// <summary>
        /// Get localized property of an entity
        /// </summary>
            ...
            where T : struct
        {
            ...
            return GetLocalizedEnum<T>(enumValue, localizationService, workContext.Language.ID);
        }
        /// <summary>
        /// Get localized value of enum
        /// </summary>
