...
using AgileEAP.Web.Models.Install;

namespace AgileEAP.Web.Controllers
{
    public class InstallController : BaseController
    {
        public InstallController(IWorkContext workContext, IRepository<string> repository)
        ...
        public ActionResult Index(InstallModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    {
                        //SQL CE
                        string databaseFileName = "AgileEAP.Db.sdf";
                    ...
                    var plugins = pluginFinder.GetPlugins<IPluginInstaller>(false)
                        .ToList()
