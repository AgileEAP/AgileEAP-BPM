...
namespace AgileEAP.WebControls
{
    ...
    public class TreeView : CompositeControl
    {
        ...
        private void InitWebResource()
        {
            ...
            {
                string url = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.TreeView.js");
                clientManager.RegisterClientScriptInclude(type, "TreeView.Resources.TreeView.js", url);
            }
     
            if (EnableDrag)
            {
                string dragURL = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.TreeViewDrag.js");
                clientManager.RegisterClientScriptInclude(type, "TreeView.Resources.TreeViewDrag.js", dragURL);
            }

            treeView_bottom_line = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.treeView-bottom-line.gif");
            treeView_middle_line = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.treeView-middle-line.gif");
            treeView_root_line = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.treeView-root-line.gif");
            treeView_top_line = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.treeView-top-line.gif");
            treeView_vertical_line = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.treeView-vertical-line.gif");
            treeView_folder = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.treeView_folder.gif");
            treeView_folder_open = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.treeView_folder_open.gif");
            treeView_minus = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.treeView_minus.gif");
            treeView_node = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.treeView_node.gif");
            treeView_plus = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.treeView_plus.gif");
            checkbox_checked = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.checkbox-checked.gif");
            checkbox_half_checked = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.checkbox-half-checked.gif");
            checkbox_unchecked = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.checkbox-unchecked.gif");
            context_menu_gradient = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.context-menu-gradient.gif");
            drag_drop_ind1 = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.dragDrop_ind1.gif");
            drag_drop_ind2 = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.dragDrop_ind2.gif");
            folder_close = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.folder_close.gif");
            folder_dots = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.folder_dots.gif");
            folder_folder = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.folder_folder.gif");
            folder_lastsub = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.folder_lastsub.gif");
            folder_open = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.folder_open.gif");
            folder_sub = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.folder_sub.gif");
            treeView_onLoad = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.treeView-onLoad.gif");

            treeView_drag_enable = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.treeView-drag-enable.gif");
            treeView_drag_disable = clientManager.GetWebResourceUrl(type, "AgileEAP.WebControls.TreeView.Resources.treeView-drag-disable.gif");
        }
