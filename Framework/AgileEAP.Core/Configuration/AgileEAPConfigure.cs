...
{
    /// <summary>
    /// Represents a AgileEAPConfigure
    /// </summary>
    public partial class AgileEAPConfigure : IConfigurationSectionHandler
    {
        #region Fields
        ...
        {
            var config = new AgileEAPConfigure();
            ...
            //var database = section.SelectSingleNode("Themes");
