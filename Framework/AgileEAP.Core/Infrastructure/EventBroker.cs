...
namespace AgileEAP.Core.Infrastructure
{
    ...
    public class EventBroker
    {
        ...
        protected void Application_BeginRequest(object sender, EventArgs e)
        {
            ...
            {
                GlobalLogger.Debug<EventBroker>("Application_BeginRequest");
        ...
        protected void Application_AuthorizeRequest(object sender, EventArgs e)
        {
            ...
            {
                GlobalLogger.Debug<EventBroker>("Application_AuthorizeRequest");
        ...
        private void Application_PostResolveRequestCache(object sender, EventArgs e)
        {
            ...
            {
                GlobalLogger.Debug<EventBroker>("Application_PostResolveRequestCache");
        ...
        private void Application_PostMapRequestHandler(object sender, EventArgs e)
        {
            ...
            {
                GlobalLogger.Debug<EventBroker>("Application_PostMapRequestHandler");
        ...
        protected void Application_AcquireRequestState(object sender, EventArgs e)
        {
            ...
            {
                GlobalLogger.Debug<EventBroker>("Application_AcquireRequestState");
        ...
        {
            GlobalLogger.Debug<EventBroker>("EventBroker: Disposing " + sender);
        }
    }
}
