    ...
    $.extend({
        progressBar: new function () {
            ...
            this.defaults = {
                ...
                width: 120, 										// Width of the progressbar - don't forget to adjust your image too!!!												// Image to use in the progressbar. Can be a single image too: '../../../Skins/Default/../../../Skins/Default/Images/progressbg_green.gif'
                height: 12, 										// Height of the progressbar - don't forget to adjust your image too!!!
                callback: null, 										// Calls back with the config object that has the current percentage, target percentage, current image, etc
                boxImage: '/Plugins/Resources/Scripts/jquery.progress/progressbar.gif', 					// boxImage : image around the progress bar
                barImage: {
                    0: '/Plugins/Resources/Scripts/jquery.progress/progressbg_green.gif',
                    30: '/Plugins/Resources/Scripts/jquery.progress/progressbg_orange.gif',
                    70:'/Plugins/Resources/Scripts/jquery.progress/progressbg_red.gif'
                },
                text:"",
                textPosition:"back",
                    ...
                    function getText(config) {
                        if (config.showText) {
                            if (config.textFormat == 'percentage') {
                                ...
                                return config.text + Math.round(config.running_value) + "%";
