...
{
    /// <summary>
    /// A class that finds types needed by AgileEAP by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        private string assemblySkipLoadingPattern = "^System|^mscorlib|^Microsoft|^CppCodeProvider|^VJSharpCodeProvider|^WebDev|^Castle|^Iesi|^log4net|^NHibernate|^nunit|^TestDriven|^MbUnit|^Rhino|^QuickGraph|^TestFu|^Telerik|^ComponentArt|^MvcContrib|^AjaxControlToolkit|^Antlr3|^Remotion|^Recaptcha|^Autofac|^WebActivator|^VMware|^Vim";

        private string assemblyRestrictToLoadingPattern = "PCI.*|AgileEAP.*|Web|Portal";// ".*";
        ...
        /// <summary>Gets or sets wether AgileEAP should iterate assemblies in the app domain when loading AgileEAP types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that AgileEAP assemblies arn't investigated (e.g. by not including something like "^AgileEAP|..." you may break core functionality.</remarks>
        ...
        public IEnumerable<Type> FindClassesOfType(Type assignTypeFrom, IEnumerable<Assembly> assemblies, bool onlyConcreteClasses = true)
        {
            ...
            catch (ReflectionTypeLoadException ex)
            {
                ...
                GlobalLogger.Error<AppDomainTypeFinder>(fail.Message, fail);
        ...
        /// <returns>A list of assemblies that should be loaded by the AgileEAP factory.</returns>
        ...
        /// <returns>True if the assembly should be loaded into AgileEAP.</returns>
