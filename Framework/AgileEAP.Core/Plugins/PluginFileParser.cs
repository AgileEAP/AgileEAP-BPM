...
namespace AgileEAP.Core.Plugins
{
    ...
    public static class PluginFileParser
    {
            ...
            foreach (var setting in settings)
            {
                ...
                switch (key)
                {
                    ...
                    case "FileName":
                        ...
                        break;
                    case "LoginUrl":
                        descriptor.LoginUrl = value;
                        break;
                    case "AutoInstall":
                        descriptor.AutoInstall = string.Equals(value, "true", StringComparison.OrdinalIgnoreCase);
                        break;
                    case "ConfigurationUrl":
                        descriptor.ConfigurationUrl = value;
                        break;
                    case "IsEnabled":
                        descriptor.IsEnabled = string.Equals(value, "true", StringComparison.OrdinalIgnoreCase);
                        break;
                    case "CanChangeEnabled":
                        descriptor.CanChangeEnabled = string.Equals(value, "true", StringComparison.OrdinalIgnoreCase);
                        break;
                }
            }

            //AgileEAPCommerce 2.00 didn't have 'SupportedVersions' parameter
        ...
        public static void SavePluginDescriptionFile(PluginDescriptor plugin)
        {
            ...
            keyValues.Add(new KeyValuePair<string, string>("LoginUrl", plugin.LoginUrl));
            keyValues.Add(new KeyValuePair<string, string>("AutoInstall", plugin.AutoInstall.ToString()));
            keyValues.Add(new KeyValuePair<string, string>("ConfigurationUrl", plugin.ConfigurationUrl));
            keyValues.Add(new KeyValuePair<string, string>("IsEnabled", plugin.IsEnabled.ToString()));
            keyValues.Add(new KeyValuePair<string, string>("CanChangeEnabled", plugin.CanChangeEnabled.ToString()));
