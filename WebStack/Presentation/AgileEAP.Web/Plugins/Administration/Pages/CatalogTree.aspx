<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="../Master/Page.Master"
    CodeBehind="CatalogTree.aspx.cs" Inherits="AgileEAP.Administration.CatalogTree" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlace" runat="server">
    <script type="text/javascript">
        ...
        var iconParentDict = "/Plugins/eCloud/Content/Themes/<%=Skin %>/Images/menu.gif";
        var iconChildDict = "/Plugins/eCloud/Content/Themes/<%=Skin %>/Images/menu.gif";
