...
(function() {
    ...
    init_: function(doc) {
      ...
      if (!doc.styleSheets['ex_canvas_']) {
        ...
        ss.cssText = 'canvas{display:inline-block;overflow:hidden;' +
            ...
            'text-align:left;width:2000px;height:4400px}' +
            'g_vml_\\:*{behavior:url(#default#VML)}' +
            'g_o_\\:*{behavior:url(#default#VML)}';
          //ss.cssText = 'canvas{display:inline-block;' +
          //    // default size is 300x150 in Gecko and Opera
          //    'text-align:left;width:2000px;height:4400px}' +
          //    'g_vml_\\:*{behavior:url(#default#VML)}' +
          //    'g_o_\\:*{behavior:url(#default#VML)}';
  ...
  function onResize(e) {
    ...
    if (el.firstChild) {
      ...
      //el.firstChild.style.height = el.clientHeight + 'px';//qiulj改取消默认300*150的尺寸
    }
  }
  ...
  function CanvasRenderingContext2D_(surfaceElement) {
    ...
    this.lineJoin = 'miter';
    this.lineCap = 'butt';
    this.miterLimit = Z * 1;//overflow: hidden
    this.globalAlpha = 1;
  ...
  //      //vmlStr.push('top:', mr(d.y / Z), 'px;left:', 0, 'px;');//qlj
  //  }
